...
public class SocketUtils {
    ...
    private enum SocketType {
        ...
        int findAvailablePort(int minPort, int maxPort) {
            AssertUtils.isTrue(minPort > 0, "'minPort' must be greater than 0");
            AssertUtils.isTrue(maxPort >= minPort, "'maxPort' must be greater than or equal to 'minPort'");
            AssertUtils.isTrue(maxPort <= PORT_RANGE_MAX, "'maxPort' must be less than or equal to " + PORT_RANGE_MAX);
        ...
        SortedSet<Integer> findAvailablePorts(int numRequested, int minPort, int maxPort) {
            AssertUtils.isTrue(minPort > 0, "'minPort' must be greater than 0");
            AssertUtils.isTrue(maxPort > minPort, "'maxPort' must be greater than 'minPort'");
            AssertUtils.isTrue(maxPort <= PORT_RANGE_MAX, "'maxPort' must be less than or equal to " + PORT_RANGE_MAX);
            AssertUtils.isTrue(numRequested > 0, "'numRequested' must be greater than 0");
            AssertUtils.isTrue((maxPort - minPort) >= numRequested,
